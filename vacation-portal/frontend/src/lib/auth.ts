...
const CLIENT_ID = 'vacation-portal'
const CLIENT_SECRET = import.meta.env.VITE_CLIENT_SECRET || 'vacation-secret'
const REDIRECT_URI = import.meta.env.VITE_REDIRECT_URI || 'http://localhost:3001/callback'
